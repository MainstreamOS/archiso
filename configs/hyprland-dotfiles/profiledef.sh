...
file_permissions=(
  ...
  ["/etc/skel/.config/hypr/custom/env.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/custom/execs.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/custom/general.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/custom/keybinds.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/custom/rules.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/custom/variables.conf"]="0:0:644"
  ...
  ["/etc/skel/.config/hypr/hyprland/colors.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/hyprland/env.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/hyprland/execs.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/hyprland/general.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/hyprland/keybinds.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/hyprland/rules.conf"]="0:0:644"
  ["/etc/skel/.config/hypr/hyprland/variables.conf"]="0:0:644"
  ...
  ["/etc/skel/.config/hypr/hyprland/shellOverrides/main.conf"]="0:0:644"
